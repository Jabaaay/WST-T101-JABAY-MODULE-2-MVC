            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize m-0">Edit Grade Details</h6>
                    </div>
                </div>
                <div class="card-body px-4 pb-4">
                    ...
                    <form action="{{ route('grades.update', $grade) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label>Student and Subject</label>
                            <input type="text" class="form-control border" value="{{ $grade->enrollment->student->first_name }} {{ $grade->enrollment->student->last_name }} - {{ $grade->enrollment->subject->subject_code }} ({{ $grade->enrollment->subject->name }})" disabled>
                            <input type="hidden" name="enrollment_id" value="{{ $grade->enrollment_id }}">
                        </div>

                        <div class="mb-3">
                            <label for="score">Score (0-100)</label>
                            <input type="number" name="score" id="score" class="form-control border @error('score') is-invalid @enderror" 
                            ...
                            <button type="submit" class="btn bg-gradient-dark">Update Grade</button>
