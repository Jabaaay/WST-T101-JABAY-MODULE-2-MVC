            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex align-items-center justify-content-between px-3">
                        <h6 class="text-white text-capitalize m-0">Add New Subject</h6>
                    </div>
                </div>
                <div class="card-body px-4 pb-4">
                    <form action="{{ route('subjects.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="subject_code" class="form-control border" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="1" name="credits" class="form-control border" required>
                        </div>
